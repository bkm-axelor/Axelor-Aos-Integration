...
public class InvoiceGstController {
  ...
  @Transactional
  public void calculateallGsts(ActionRequest request, ActionResponse response)
    ...
    if (invoice.getPartner() != null
      ...
      for (InvoiceLine invoiceLine : invoiceLineList) {
        ...
        BigDecimal calculateGst =
            Beans.get(InvoiceLineGstServiceImpl.class).calculateGst(invoiceLine);
        ...
        if (companyState.equals(addressState)) {
          BigDecimal calculateCGst =
              Beans.get(InvoiceLineGstServiceImpl.class).calculateCGst(invoiceLine, calculateGst);
          invoiceLine.setCgst(calculateCGst);
          invoiceLine.setSgst(calculateCGst);
          invoiceLine.setIgst(BigDecimal.ZERO);
        } else {
          BigDecimal calculateIGst =
              Beans.get(InvoiceLineGstServiceImpl.class).calculateIGst(invoiceLine, calculateGst);
